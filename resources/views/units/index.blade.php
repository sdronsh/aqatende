                ...
                <tbody>
                    @forelse ($units as $unit)
                        <tr class="odd:bg-gray-50">
                            <td class="border border-gray-200 px-4 py-3 font-medium text-gray-800" data-label="Nome">{{ $unit->name }}</td>
                            <td class="border border-gray-200 px-4 py-3 text-gray-600" data-label="Clinica">{{ $unit->clinic?->name }}</td>
                            <td class="border border-gray-200 px-4 py-3 text-gray-600" data-label="Cidade">{{ $unit->city }} / {{ $unit->state }}</td>
                            <td class="border border-gray-200 px-4 py-3 text-gray-600" data-label="Especialidades">
                                {{ $unit->specialties?->pluck('name')->take(3)->join(', ') ?: '-' }}
                            </td>
                            <td class="border border-gray-200 px-4 py-3 text-gray-600" data-label="Telefone">{{ $unit->phone }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="border border-gray-200 px-6 py-6 text-center text-gray-500" data-empty>Nenhuma unidade cadastrada.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
