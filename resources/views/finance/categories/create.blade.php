    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-lg font-semibold text-gray-800">Nova categoria</h2>
            </div>
        </div>
    </x-slot>

    <form method="POST" action="{{ route('finance.categories.store') }}" class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-sm space-y-4">
        @csrf
